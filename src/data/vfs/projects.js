...
export const projectsDirectory = createDirectory({
  'mikrotik-voucher.md': createFile(
    `# Mikrotik Voucher Tester\nURL: https://github.com/hamk4dev/Mikrotik-voucher-tester\n\nPengembangan utility untuk membantu pengujian voucher jaringan berbasis Mikrotik secara lebih cepat, terukur, dan efisien dalam konteks operasional jaringan.`
  ),
